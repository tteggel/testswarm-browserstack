 ...
 */
 var map = {
   ...
   "WinXP|Chrome|23": { version: '23.0', browser: 'chrome', os: 'win' },
   ...
   "MacOSX|Firefox|15": { version: '14.0', browser: 'firefox', os: 'mac' },
   "MacOSX|Firefox|16": { version: '14.0', browser: 'firefox', os: 'mac' },
